...
public class Menu : MonoBehaviourPunCallbacks, ILobbyCallbacks
{
    ...
    public void GetPlayerInfo()
    {
        ...
        result =>
        {
            ...
            playerName.text = result.PlayerProfile.DisplayName;
        },
    ...
    public void defaultRoomName()
    {
        string k = playerName.text;

        if (!string.IsNullOrEmpty(k) && (k[k.Length - 1] == 's' || k[k.Length - 1] == 'S'))
        {
            k += "' room";
        }
        else
    ...
    {
        UpdateLobbyUI();
        //SpriteManager.instance.OnReset();
    }
    public void OnStartGameButton()
    {
        ...
        //NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "Menu-M");
    ...
    public void LoadRollBallGameM()
    {
        NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "Rollball-M");
    }
    public void LoadTankGameM()
    {
        NetworkManager.instance.photonView.RPC("ChangeScene", RpcTarget.All, "TankGame");
    }
